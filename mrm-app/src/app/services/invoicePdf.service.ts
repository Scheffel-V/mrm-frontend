...
export class InvoicePdfService {
   ...
   * @param rentalId 
   */
  async generateInvoicePdf(rentalId: number) {
  ...
  updateAdditiveCode(invoice) {
    let additives = invoice.additives;
  ...
  getInvoiceDefinition(invoice) {
    let itemsRows = [];
    invoice.itemRentals.map(item => {
      itemsRows.push(this.getContractFromStockItem(item));
      this.addItemValue(item.value);
    });
    this.discount = invoice.value - (this.totalItemsAmount + invoice.deliveryCost);
    this.updateAdditiveCode(invoice);
                ...
                stack: [
                  ...
                  this.renderAdditive(),
                  {
                    columns: [
                      ...
                      {
                        text: this.dateFormatter.format(new Date(invoice.startDate.toDateString())),
                        bold: true,
                        color: '#333333',
                        fontSize: 10,
                        alignment: 'right',
                  ...
                  },
                  {
                    columns: [
                      ...
                      {
                        text: this.dateFormatter.format(new Date(invoice.endDate.toDateString())),
                        bold: true,
                        color: '#333333',
                        fontSize: 10,
                        alignment: 'right',
                  ...
                  this.renderPaymentDueDate(invoice)
                ],
              },
            ],
          ],
        ...
        '\n\n',
        {
          ...
          table: {
            ...
            body: [
              ...
              this.renderDeliveryCost(invoice),
              this.renderDiscount(),
              [
                {
                  text: 'Valor Total',
                ...
                {
                  text: this.formatter.format(invoice.value),
                  bold: true,
                  fontSize: 12,
                  alignment: 'right',
                  border: [false, false, false, true],
              ...
              [
                ...
                {
                  border: [false, false, false, true],
                  text: invoice.installments === 1 ? 'à vista' : `${invoice.installments} vezes`,
                  alignment: 'right',
                  fontSize: 10,
                  fillColor: '#f5f5f5',
                  margin: [0, 5, 0, 5],
