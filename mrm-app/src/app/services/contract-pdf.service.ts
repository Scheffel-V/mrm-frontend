...
const CLAUSES = [
  ...
  {
    id: "3.2",
    content: "Grupo Gerador de Energia: a LOCATÁRIA é responsável por deixar pronto disjuntores e rede interna da empresa do cliente, onde os técnicos da LOCADORA farão a ligação dos cabos na rede elétrica do cliente. A LOCADORA não fará troca de disjuntores ou de cabos da rede interna da locatária, devendo ser chamado eletricista próprio ou terceirizado. O abastecimento do Gerador de energia deve ser previamente combinado e formalizado no Orçamento e nas observações deste contrato, entretanto fica estabelecido que sendo por conta do cliente, o mesmo deve abastecê-lo com Diesel S10."
  },
  {
    id: "3.3",
    content: "Compressores de ar elétricos, secadores de ar, schiller de refrigeração: : a LOCATÁRIA é responsável por deixar pronto disjuntores e rede interna da empresa do cliente, onde os técnicos da LOCADORA farão a ligação dos cabos na rede elétrica do cliente. A LOCADORA não fará troca de disjuntores ou de cabos da rede interna da locatária, devendo ser chamado eletricista próprio ou terceirizado. Também deve deixar pronta a rede de ar ou qualquer que deva ser conectada a máquina locada. Não sendo parte do contrato de locação qualquer tipo de instalação industrial como colocação de tubulações ou cabos."
  },
  {
    id: "3.4",
    content: "Para a instalação, a LOCADORA disponibiliza 5 metros de cabo para ligação da máquina, havendo necessidade de maior quantidade, deve ser informado a LOCADORA no ato de confirmação da locação, e um valor a mais será cobrado quando for quantidade acima de 5 metros."
  },
  {
    id: "3.5",
    content: "Em caso de locação dos equipamentos para uso em obras e construções, a máquina, especialmente compressores elétricos deverão ser instalados a uma distância que não gere a absorção da sujeira advinda da obra, o que pode gerar a obstrução do radiador, dano ao filtro separador e de óleo."
  },
  {
    id: "3.6",
    content: "Os equipamentos elétricos devem sempre ser instalados em local coberto por telhado e paredes, em sala espaçosa com boa ventilação, a falta de local adequado caracteriza mau uso, pois eleva excessivamente a temperatura do equipamento, causando  seu desarme."
  },
  {
    id: "3.7",
    content: "Em caso de uso dos equipamentos elétricos em local mau coberto, deve ser solicitado a LOCATÁRIA skid para proteção do mesmo. Se solicitada por parte da LOCATÁRIA  a instalação para os técnicos da gma, será sem custo de deslocamento desde que a locatária esteja até 100km/h da sede da gma. Caso contrário, o deslocamento fica fixado no valor de R$ 2,20 por quilometro rodado (valor pode ser negociado)."
  },
  {id: "\n\n4) DO PRAZO CONTRATUAL", content: ""},
  {
    id: "4.1",
    content: "O presente contrato tem prazo determinado, conforme citado na Clausula 1 (data de inicio e data de término)."
  },
  {
    id: "4.2",
    content: "O primeiro período de locação que for contratado deve ser cumprido em sua totalidade, mesmo que a máquina seja devolvida antes do final do período, não haverá reembolso e sequer cobrança proporcional da locação."
  },
  {
    id: "4.3",
    content: "No término do prazo acima estipulado, acaso haja interesse das partes em renovar o contato, a parte que demonstrar interesse na renovação deverá comunicar a outra parte por escrito, com antecedência mínima de 3 (três) dias antes do término do contrato, especificando o prazo total de duração da referida renovação contratual pretendida."
  },
  {
    id: "4.4",
    content: "O contrato será renovado automaticamente, pelo mesmo período, se o Locatário não efetuar a devolução da máquina alugada ao Locador, impreterivelmente até o dia do vencimento do contrato."
  },
  {
    id: "4.5",
    content: "Entretanto, não havendo interesse na renovação, haverá a rescisão do contrato, bastando para isso a comunicação da LOCATÁRIA do dia e horário em que a LOCADORA receberá em sua sede a restituição dos bens locados, com a realização de vistoria no ato da entrega do bem."
  },
  {
    id: "4.6",
    content: "Se o prazo for igual a 30 dias, se renovará pelo mesmo período. Sendo inferior a 30 dias, se renovará por igual período."
  },
  {
    id: "4.7",
    content: "Após o cumprimento total do primeiro período de locação contratado, na renovação, poderá não ser cumprido totalmente, neste caso será calculado e cobrado o valor proporcional aos dias usados (calculo: período locado dividido pelo valor da locação, multiplicado pelos dias usados)."
  },
  {
    id: "4.8",
    content: "Quando a LOCADORA for responsável pelo frete de devolução (retorno) do equipamento locado, a LOCATÁRIA terá a obrigação de avisar formalmente , no prazo de 48 horas do término de locação, que o contrato irá se encerrar e que declina de interesse de renovação. Caso a LOCADORA não seja informada, poderá ser cobrado o valor de uma diária proporcional."
  ...
  {
    id: "4.9",
    content: "Havendo interesse, pode-se realizar contrato para período longos (considera-se a longos a partir de 06 meses), nesse caso, a LOCADORA poderá negociar valor promocional a seu critério, entretanto, após tratado e formalizado interesse por email ou whatsapp, o período deverá ser cumprido, podendo acarretar em multa contratual de 20% (vinte por cento) da soma total do contrato (valor mensal multiplicado pelo período contratado)."
  },
  {id: "\n\n5) DO VALOR", content: ""},
  {
    id: "5.1",
    content: "O valor do aluguel mensal, quinzenal ou diárias, citado no campo 1.0, deverá ser pago diretamente para a empresa LOCADORA, até o dia e mês citado no campo 1.0;"
  },
  {
    id: "5.2",
    content: "O pagamento pode se dar mediante BOLETO, DEPÓSITO OU CARTÃO DE CRÉDITO (neste último caso, com taxas da máquina de cartão a acrescer), que será negociado entre LOCATÁRIO E LOCADOR."
  },
  {
    id: "5.3",
    content: "Havendo o envio de boleto para a LOCATÁRIA, não poderá ocorrer o pagamento de outra forma, mesmo que esteja vencido, se for pago em atraso, os juros deverão ser arcados pela LOCATÁRIA."
  },
  {
    id: "5.4",
    content: "Caso a LOCATÁRIA mesmo assim deposite o valor da locação, descumprindo o combinado, será cobrada na próxima fatura os juros e taxas advindos da baixa e atraso do boleto. Que pode variar de acordo com os dias em atraso."
  },
  {
    id: "5.5",
    content: "Os boletos vencidos serão enviados para cobrança em cartório, ocorrendo assim, o cliente deverá aguardar o boleto do respectivo cartório da sua cidade. 5.6 Após isso, mesmo em caso de depósito por parte da LOCATÁRIA do valor a conta da LOCADORA, mediante o envio do comprovante de depósito, e estiver dentro de prazo estipulado por cartório, a LOCADORA poderá pedir a susta do protesto, entretanto, a taxa cobrada pelo cartório será repassada a LOCATÁRIA, no período de locação seguinte, ou caso não haja renovação deverá ser pago a LOCADORA mediante boleto ou depósito."
  },
  {
    id: "5.6",
    content: "Acaso ocorra a hipótese prevista nas cláusulas 4.3 e 4.4, o valor do aluguel será reajustado anualmente pelo IGP-M, acrescido de 10 pontos percentuais."
  },
  {id: "\n\n6) DA MORA", content: ""},
  {
    id: "6.1",
    content: "Em caso de atraso no pagamento do aluguel, o valor em aberto será corrigido pelo IGP-M e, sobre ele, incidirá juros de 1% ao mês, desde o vencimento do valor devido até a data do efetivo pagamento."
  },
  {
    id: "6.2",
    content: "Além da correção monetária e da incidência de juros, sobre o valor vencido incidirá multa compensatória de 10% (dez por cento) do valor total em atraso."
  },
  {id: "\n\n7) DA CESSÃO OU SUBLOCAÇÃO", content: ""},
  {
    id: "7.1",
    content: "A cessão ou transferência da presente locação, ou sublocação, no todo ou em parte do objeto deste contrato, somente poderá ocorrer mediante autorização escrita da LOCADORA, sob pena de plena rescisão do presente contrato. Devendo o pedido ser formalizado por e-mail. A sublocação não é permitida."
  },
  {
    id: "7.2",
    content: "Em caso de locação para uso em obras, o LOCATÁRIO deve sempre informar a LOCADORA do local onde o equipamento irá trabalhar, formalizando a alteração por e-mail ou Whatsapp."
  },
  {
    id: "7.3",
    content: "Ocorrendo a hipótese prevista na cláusula 7.1, a LOCATÁRIA arcará com multa contratual de 20% (vinte por cento) do valor total do contrato, ficando inteiramente responsável pelos bens locados, inclusive por sua conservação."
  },
  {id: "\n\n8) DAS OBRIGAÇÕES DA LOCADORA", content: ""},
  {
    id: "8.1",
    content: "A LOCADORA é responsável por indenizar a LOCATÁRIA na ordem inversa deste, se os equipamentos objeto deste contrato não atenderem a finalidade a que foram locados, no caso de falhas irreversíveis e de que dependa a substituição dos equipamentos."
  },
  {
    id: "8.2",
    content: "Durante o período em que os bens permanecerem locados para a LOCATÁRIA, e sendo necessário qualquer assistência técnica, ou manutenção corretiva advindas de desgaste natural de peças, essa será prestada exclusivamente pela LOCADORA, ou sob sua supervisão, sob pena de rescisão contratual."
  },
  {
    id: "8.3",
    content: "Instruir e estar à disposição do cliente para eventuais dúvidas referente ao uso do equipamento."
  },
  {
    id: "8.4",
    content: "Dispor de máquina reserva igual ou similar em estoque, em caso de problemas sérios com a máquina locada, salvo o frete que deverá ser por conta da LOCATÁRIA. Havendo necessidade de envio de máquina de maior potência, o valor de locação será reajustado conforme a tabela de locação vigente."
  },
  {
    id: "8.5",
    content: "As manutenções preventivas das máquinas são por conta e responsabilidade da LOCADORA, e os intervalos podem variar de acordo com o regime de uso diário da máquina por parte do cliente ou pelo nível de sujeira dentro das dependências do mesmo."
  },
  {
    id: "8.6",
    content: "Fazer a limpeza do equipamento evitando o super aquecimento da máquina, com periodicidades variando conforme a sujeira do local instalado, devendo a LOCATÁRIA fazer chamado de técnico. Havendo chamado por parada na máquina locada, a LOCADORA tem até 72 horas para atender a LOCATÁRIA sem gerar nenhum tipo de ônus para as partes."
  },
  {id: "\n\n9) DAS OBRIGAÇÕES DA LOCATÁRIA", content: ""},
  {
    id: "9.1",
    content: "Em caso de ocorrência de danos externos aos bens locados, a manutenções advindas desses casos serão cobradas exclusivamente da LOCATÁRIA. Ou caso o dano seja irreversível, deverá ser ressarcido pela LOCATÁRIA."
  },
  ...
  {
    id: "-",
    content: "Uso por parte da locatária de cabos danificados ou mal colocados ou sem aterramento quando é necessário que seja feito;"
  },
  {id: "-", content: "Roubo ou furto da máquina ou de partes e peças dela;"},
  {id: "-", content: "Incêndio ou avarias"},
  {
    id: "-",
    content: "Amassados na lataria da máquina causados por falta de cuidado no transporte ou descarregamento da máquina; Ou entrada de material corrosivo como tinta ou cimento, corroendo a lataria da máquina."
  },
  {
    id: "-",
    content: "Instalação da máquina em local insalubre, como próximo de cimento, tinta, ou qualquer material que, absorvido pela máquina ocasione estragos ao equipamento. Pois a absorção desse material corrosivo para dentro da rede da máquina e danificando partes como o radiador, filtro separador, filtro de ar;"
  },
  {
    id: "9.3",
    content: "As movimentações de máquinas dentro da empresa LOCATÁRIA também devem ser informadas a LOCADORA."
  },
  {
    id: "9.4",
    content: "Em caso de ocorrência de falha ou dificuldade de funcionamento adequado no equipamento locado, a LOCATÁRIA deverá comunicar imediatamente e inclusive por escrito a LOCADORA, para que possa solucionar de plano tais ocorrências. Não podendo a LOCATÁRIA realizar a substituição de peças da máquina sem autorização por escrito da LOCADORA, entre eles: troca de filtro de ar, filtro de óleo, filtro separador, contactores, e especialmente óleo quando for um diferente do óleo usado pela LOCADORA, sem a autorização da LOCADORA."
  },
  {
    id: "9.5",
    content: "Em caso de a LOCATÁRIA observar mau funcionamento no equipamento locado e não comunicar a LOCADORA imediatamente, e o equipamento tiver seu funcionamento ainda mais prejudicado por esse motivo, a LOCATÁRIA arcará com os custos necessários para os devidos consertos."
  },
  {
    id: "9.6",
    content: "Responsabilidade da LOCATÁRIA monitorar o funcionamento do equipamento enquanto locado, realizando testes e rotinas, afim de garantir o perfeito desempenho do equipamento."
  },
  {
    id: "9.7",
  ...
  {
    id: "10.1",
    content: "Na entrega dos bens locados, as partes farão uma vistoria relatando o estado em que se encontram os bens. Estando nas mesmas condições em que foram locados, e sendo quitados todos os aluguéis e encargos, o presente contrato se dá por rescindido."
  },
  {
    id: "10.2",
    content: "Todos os itens locados e acessórios para instalação do equipamento deverão ser devolvidos junto do equipamento, sendo mencionados na nota fiscal de retorno dos equipamentos."
  },
  ...
  {
    id: "11.2",
    content: "Na ocorrência de quaisquer das hipóteses previstas na cláusula 11.1, não assistirá ao locatário qualquer direito à indenização ou reclamação."
  },
  {id: "\n\n12) DAS DISPOSIÇÕES FINAIS", content: ""},
  {
    id: "12.1",
    content: "Por se tratar de locação de bens móveis sem necessidade de operador, dispensada de emissão de nota fiscal de serviço por não configurar atividade de prestação de serviço."
  },
];
...
export class ContractPDFService {
  ...
  async getContractBlob(rentalId: number): Promise<any> {
    this.totalItemsAmount = 0.0;
    this.customer = null;
    this.rental = null;
    this.items = [];
    ...
    try {
      await this.fetchRentalAsync(rentalId);
      const test = await this.getPdfBlob(this.rental);
      return test;
    } catch (e) {
      console.log("Some error happened while fetching the rental data");
    }
  ...
  async fetchRentalAsync(id: number): Promise<void> {
    this.rental = await this.rentalService.getRental(id).toPromise();
    this.rental.startDate = new Date(this.rental.startDate)
    this.rental.endDate = new Date(this.rental.endDate)
    this.rental.approvalDate = this.rental.approvalDate == null ? null : new Date(this.rental.approvalDate)
    this.rental.paymentDueDate = this.rental.paymentDueDate == null ? null : new Date(this.rental.paymentDueDate)
  ...
  async getPdfBlob(rental): Promise<any> {
    await this.getCustomer(rental.customerId);
    const contractDefinition = this.generatePDFTemplate(rental);
    return this.pdfMake.createPdf(contractDefinition);
  }
